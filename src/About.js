    ...
    <div id='rightContent' className="flex h-full w-full mb-10">
       <div className=" h-screen w-full p-6 md:p-14 lg:p-20 xl:p-28 2xl:p-28  bg-gray-100  flex flex-row  justify-start items-center" >
        ...
        <div className="rounded-full h-72 w-72 md:h-72 md:w-72 lg:h-72 lg:w-72 xl:h-80 xl:w-80 2xl:h-96 2xl:w-96  shadow-lg shadow-blue-400 flex justify-center items-center ">
            <img src="akarsh.github.io/akarsh.jpg" alt="" className="  mx-auto rounded-full  h-72 w-72 md:h-72 md:w-72 lg:h-72 lg:w-72 xl:h-80 xl:w-80 2xl:h-96 2xl:w-96 3xl:h-96 3xl:w-96"/>
        </div>
        <div className="flex flex-col my-auto space-y-2">
            ...
            <Link to="https://linkedin.com/in/akarsh-srivastava-bb548a1a4" target="_blank" rel="noreferrer"><div className="h-7 w-7 bg-blue-900 ease p-1 mb-2 hover:scale-105 duration-700 rounded-sm flex flex-col justify-center item-center cursor-pointer">
            <img src="akarsh.github.io/linkedin.png" alt="" className="w-4 h-4 animate-bounce flex justify-center item-center mx-auto  " />
            </div></Link>
